...
router.put("/:id", verifyTokendAndAuthorization, async (req, res) => {
...
//get all users
router.get("/find/:id", verifyTokendAndAdmin, async (req, res) => {
  try {
...
router.get("/stats",verifyTokendAndAdmin,async(req,res)=>{
  const date=new Date();
